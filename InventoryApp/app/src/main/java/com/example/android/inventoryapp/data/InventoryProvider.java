...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String price = values.getAsString(InventoryContract.InventoryEntry.COLUMN_PRODUCT_PRICE);
        if (price == null) {
            throw new IllegalArgumentException("Product requires a valid price");
        }

        String email = values.getAsString(InventoryContract.InventoryEntry.COLUMN_PRODUCT_SUPPLIER_EMAIL);
        if (email == null) {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            default:
                throw new IllegalArgumentException("Unknown URI " + uri + "witch match " + match);
        }
    }
